#ifndef WEDGE3_STATS_H
#define WEDGE3_STATS_H
...
class WEDGE3_EXPORT Fixed_Stats
{
public:
	Fixed_Stats();
...
class WEDGE3_EXPORT Base_Stats
{
public:
	Base_Stats();
...
class WEDGE3_EXPORT Weapon_Stats
{
public:
	Weapon_Stats();
	Weapon_Stats(int id);
...
class WEDGE3_EXPORT Armour_Stats
{
public:
	Armour_Stats();
	Armour_Stats(int id);
...
class WEDGE3_EXPORT Player_Stats
{
public:
	Player_Stats();
