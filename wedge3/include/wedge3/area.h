#ifndef WEDGE3_AREA_H
#define WEDGE3_AREA_H
...
class WEDGE3_EXPORT Area_Hooks
{
public:
	struct Scroll_Zone
	{
...
bool WEDGE3_EXPORT entity_y_compare(Map_Entity *a, Map_Entity *b);
